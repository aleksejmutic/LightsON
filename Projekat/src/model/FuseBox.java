...
public class FuseBox extends Element {
	...
	private static String imagePath = "icons/fuseElement.png"; // Adjust to your image's path
	...
	public FuseBox(Point point, Point endPoint, int width, int height) {
