...
public class Consumer extends Element {
	...
	private static String imagePath = "icons/light-bulb1.png"; // Adjust to your image's path
	...
	public Consumer(Point point, Point endPoint, int width, int height) {
