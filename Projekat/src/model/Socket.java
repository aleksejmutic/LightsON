...
public class Socket extends Element {
	...
	private static String imagePath = "icons/socket1.png"; // Adjust to your image's path
	...
	public Socket(Point point, Point endPoint, int width, int height) {
