...
public class JunctionBox extends Element {
	...
	private static String imagePath = "icons/flash.png"; // Adjust to your image's path
	 ...
	 */
	public void initializeJunctionPoints() {
	    ...
	    for (int i = 0; i < 4; i++) {
	        ...
	        switch (i) {
	            case 0: // Top
	                ...
	                break;
	            case 1: // Right
	                jpX = point.x + width - OFFSET + 10;     // Aligned with the right edge of the box
	                jpY = point.y + height / 2 - OFFSET; // Vertically centered on the right edge
	                break;
	            case 2: // Bottom
	                ...
	                break;
	            case 3: // Left
	                jpX = point.x - OFFSET - 10;              // Aligned with the left edge of the box
	                jpY = point.y + height / 2 - OFFSET; // Vertically centered on the left edge
	                break;
	        }
	...
	public void draw(Graphics g) {
		...
		g2.drawLine(point.x + width, point.y + height / 2, (int) this.getJunctionPoints().get(1).getX(),
				(int) this.getJunctionPoints().get(1).getY());
		g2.drawLine(point.x + width / 2, point.y + height, (int) this.getJunctionPoints().get(2).getX(),
				(int) this.getJunctionPoints().get(2).getY());
		g2.drawLine(point.x, point.y + height / 2, (int) this.getJunctionPoints().get(3).getX(),
				(int) this.getJunctionPoints().get(3).getY());
	...
	@Override
	public void setJunctionPoints(List<JunctionPoint> junctionPoints) {
		super.setJunctionPoints(junctionPoints);
	}
